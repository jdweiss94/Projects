...
{
	/**
	 * Used to implement first fit algorithm
	 * @param free array of free spaces in memory
	 * @param jobs array of jobs to be taken care of
	...
	/**
	 * Used to implement best fit algorithm
	 * @param free array of free spaces in memory
	...
	/**
	 * Used to implement next fit algorithm
	 * @param free array of free spaces in memory
	 * @param jobs array of jobs
	 * @return output string
	 */
	...
	/**
	 * Used to implement worst fit algorithm
	 * @param free array of free spaces in memory
	 * @param jobs array of jobs
	 * @return output string
	 */
